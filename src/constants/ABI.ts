...
export const ETH_TOKEN_ABI = [
  ...
  {
    inputs: [],
    name: 'isContractTransferFeeEnabled',
    outputs: [
      {
        internalType: 'bool',
        name: '',
  ...
  {
    inputs: [],
    name: 'isWalletTransferFeeEnabled',
    outputs: [
      {
        internalType: 'bool',
        name: '',
  ...
  {
    inputs: [],
    name: 'toggleContractTransferTax',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
